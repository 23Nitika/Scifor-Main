...
from .forms import WorkExperienceForm, EducationForm, ProjectForm
        ...
        try:
            ...
            if result is not None:
                ...
                try:
                    ...
                    # Save payment details to PaymentHistory
                    PaymentHistory.objects.create(
                        user=request.user,
                        course_title="Sample Course",  # Replace with actual course title
                        date=timezone.now(),
                        total_price=amount / 100,  # Amount is in paise
                        payment_type="Razorpay",
                        receipt_invoice=payment_id
                    )
